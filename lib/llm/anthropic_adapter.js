...
export async function* streamAnthropic({ baseUrl, apiKey, model, messages, modelType, modelOptions, maxChars, maxOutputTokens, temperature, enableReasoning, timeoutMs, signal, tools, headers }) {
