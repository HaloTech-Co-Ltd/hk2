...
export async function* streamAnthropic({ baseUrl, apiKey, model, messages, modelType, modelOptions, maxChars, temperature, enableReasoning, timeoutMs, signal, tools, headers }) {
