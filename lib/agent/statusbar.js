...
export class StatusBar {
  ...
  update() {
    ...
    const shrank = planCount < prevCount;
    // Cache the new count; _applyScrollRegion uses it to size the region.
