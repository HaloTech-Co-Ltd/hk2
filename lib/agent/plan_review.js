 ...
 * Part 1 === REVIEW REPORT === (shared marker from code_review.js) - the
 *   streaming, human-readable analysis
 ...
 * @param {{signal?: AbortSignal, onDelta?: (text: string) => void, onReasoning?: (text: string) => void}} [opts]
  ...
  try {
    ...
    const raw = await callLlm(
      ...
      messages,
      {
        ...
        //
        // Reasoning is ALWAYS on for plan review: judging a plan is a deep
        // reasoning task, and a fast no-thinking pass is exactly the shallow
        // rubber-stamp review this phase exists to prevent.
