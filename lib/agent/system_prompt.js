...
- When you discover something reusable, call kb_save_knowledge to persist it. Pick the space by stability:
    - **Holy** for stable design knowledge (e.g. "how to write a Halo/PG extension", "how the WAL replay loop works"). The user will be prompted y/N before commit even with auto-learn on.
