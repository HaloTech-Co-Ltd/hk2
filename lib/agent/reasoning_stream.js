 ...
 *    default (HK2_HIDE_THINKING unset or =1) only the first 9 content lines
 ...
 *   unset / '1' / * -> 9 — cap the thinking window at 9 content lines
...
function thinkingLineBudget() {
  return (process.env.HK2_HIDE_THINKING ?? '').trim() === '0' ? Infinity : 9;
}
