 ...
 * each step with 2-4 candidate strategies, one marked recommended — the
 * recommended shape; normalization enforces only minimums) when it
  ...
  const tools = [
    ...
    },
    {
      ...
      parameters: {
        type: 'object',
        properties: {
          summary: { type: 'string', description: 'Recommended: one-line summary of the whole plan; normalization uses an empty string when it is missing or not a string' },
          steps: {
            type: 'array',
