  ...
  if (allowWrite) {
    tools.push({
      ...
      guidelines: [
        ...
        'Multi-edit entries are applied sequentially in array order against the evolving in-memory content. Each oldText must be unique at the moment its entry is processed; later entries may observe text produced by earlier ones.',
