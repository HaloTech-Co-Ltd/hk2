  ...
  if (rt) {
    tools.push(
      ...
      },
      {
        ...
        description: 'Look up a class, interface, struct, or enum by name (or qualified name). Returns: signature, doc string, members (methods + fields), super-classes, and direct implementations.',
        parameters: {
          type: 'object',
          properties: {
