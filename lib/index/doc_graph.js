...
export function buildDocGraph(input) {
  ...
  const docRecords = {};
  const tables = [];
  // Null-prototype map: symbol names can collide with Object.prototype members
  // (e.g. a class method literally named `constructor` or `toString`), which
  // would make the truthiness check below hit the inherited property instead
  // of undefined and leave `lst` as a non-array.
  const symbolMentions = Object.create(null);
