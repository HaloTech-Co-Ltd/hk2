 ...
 *   - is self-healed (re-created empty, never overwriting existing content)
 *     at KB runtime load and by /kb status for projects initialized before
 *     this feature; status therefore has a rare write-on-read side effect,
