...
- [CLI 与语言支持](reference/cli-and-language-support.md)——一次性 CLI 参数；各语言使用 Tree-sitter、正则回退或文档解析的情况

## 开发

- [架构](development/architecture.md)——组件、数据流、模块边界
- [测试与贡献](development/testing-and-contributing.md)——运行测试套件、提交前检查清单
- [文档维护](development/documentation-maintenance.md)——如何保持本文档体系的双语一致性和准确性
