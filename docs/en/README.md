...
purpose-built for coding. Each project has its own knowledge base, bringing
together code symbols, a code knowledge graph, and curated knowledge entries.
The agent can retrieve and use this knowledge alongside conversation context,
helping future development build on an existing understanding of the project.
...
- [Quick start](getting-started/quick-start.md) — configure a model, build a KB, and ask your first question
