...
| `HK2_ASSESS_REASONING` | When 1, the request-clarity assessment LLM call runs with deep reasoning enabled (helps pragmatic reference resolution on strong models; adds latency). | `0` |
